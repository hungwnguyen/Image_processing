...
public class WebGLUpload : MonoBehaviour
{
    ...
    /// </summary>
    public void UploadTexture(ImageFormat imageFormat, int maxSize, bool nonReadable, Material targetMaterial = null, RawImage targetImage = null)
    {
    ...
    private IEnumerator LoadTexture(string url)
    {
        ...
        else
        {
            ...
            this._fileName = Path.GetFileNameWithoutExtension(url);
            ...
            //Debug.Log(_targetImage.texture.GetType().ToString());
        }
    }
